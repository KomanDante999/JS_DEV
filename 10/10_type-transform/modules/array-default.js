const arrayStudentDefault = [
  ...
  {surname: 'Елкина', name: 'Алена', middleName: 'Павловна', birthDate: new Date('1995-11-3'), yearAdmission: 2016, faculty: 'физика-математика'},
  {surname: 'Елкина', name: 'Алёна', middleName: 'Павловна', birthDate: new Date('1995-11-3'), yearAdmission: 2016, faculty: 'физика-математика'},
  {surname: 'Ёлкина', name: 'Алена', middleName: 'Павловна', birthDate: new Date('1995-11-3'), yearAdmission: 2016, faculty: 'физика-математика'},
  {surname: 'Ёлкина', name: 'Алёна', middleName: 'Павловна', birthDate: new Date('1995-11-3'), yearAdmission: 2016, faculty: 'физика-математика'},
